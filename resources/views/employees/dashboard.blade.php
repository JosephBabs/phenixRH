    ...
    <div class="page-inner py-5" >
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <a href="{{ route('payments.index')  }}" class="sidebar-li btn btn-white btn-border btn-round mr-2">Gérer les paiements</a>
                <a href="{{ route('employees.index')  }}" class="sidebar-l btn btn-secondary btn-round">Ajouter un employé</a>
            </div>
        </div>
    </div>
</div>
